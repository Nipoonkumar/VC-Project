...
<h2>Register as Investor</h2>
    ...
    <div>
      <label htmlFor='vcname'>Name</label><br></br>
      <input type="text" autoComplete='on'
      value={userregisteration.vcname} onChange={handleInput}
      name="vcname" id="vcname" className='txtForm'/>
    </div>
    <div>
      <label htmlFor='email'>Email</label><br></br>
      <input type="text" autoComplete='off'
      value={userregisteration.email} onChange={handleInput}
      name="email" id="email" className='txtForm'/>
    </div>
    <div>
      <label htmlFor='vclinkedin'>Linkedin</label><br></br>
      <input type="url" autoComplete='off'
      value={userregisteration.vclinkedin} onChange={handleInput}
      name="vclinkedin" id="vclinkedin" className='txtForm'/>
    </div>
    <div>
      <label htmlFor='contact'>Phone</label><br></br>
      <input type='tel' autoComplete='off'
      value={userregisteration.contact} onChange={handleInput}
      name="contact" id="contact"
       minLength='10' maxLength='10' className='txtForm'/>
    </div>
    <div>
      <label htmlFor='expertise'>Expertise</label><br></br>
      <input type="textArea" autoComplete='off'
      value={userregisteration.expertise} onChange={handleInput}
      name="expertise" id="expertise" className='txtForm'/>
    </div>
    <div>
    ...
    <div>
      ...
      name="state" id="state" placeholder='state'/><br></br>
      <input type="text" autoComplete='off'
